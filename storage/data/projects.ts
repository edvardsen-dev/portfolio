...
export const projects = [
	...
	},
	{
		...
		title: 'CSGO Nade App',
		description:
			'CSGO Strats is an open-source project to create a CSGO website where players can create and share strategies with the community and their teams. With user authentication, team and start creation, and the ability to upload images illustrating nade lineups, CSGO Strats provides a platform for gamers to enhance their gameplay.',
		updatedAt: new Date('2023-05-10T11:03:00'),
		imgBasePath: getProjectImgBasePath('csgostrats'),
		thumbnail: {
			name: 'view-strat.PNG',
	...
	},
	{
		...
		title: 'Sphere',
		description:
			'Sphere is an application that helps you keep track of your subscriptions. With a dashboard that shows you the total cost of all your subscriptions, as well as a list of all your subscriptions and the ability to add new ones.',
		updatedAt: new Date('2023-05-10T11:03:00'),
		imgBasePath: getProjectImgBasePath('sphere'),
		thumbnail: {
			name: 'dashboard.PNG',
		...
		resources: [
			{
				label: 'Repository:',
				href: 'https://github.com/jKm00/sphere'
			}
		],
		live: null,
		content: [
